function Platforms() {
  return (
    <article className="mb-16 px-4">
      ...
      <div className="mb-8">
        <h4 className="font-bold text-lg mb-4">기영 카카오</h4>
        <p>
